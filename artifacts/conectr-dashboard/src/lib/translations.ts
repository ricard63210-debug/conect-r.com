    ...
    landing: {
      ...
      pricing: {
        ...
        bundle: {
          ...
          setupLabel: "Configuración única, desde $100",
          setupOriginal: "$2,650",
          setupNow: "$1,800",
          setupSavings: "Ahorro inicial: $850 USD",
          monthlyLabel: "Mantenimiento mensual, desde $100",
    ...
    landing: {
      ...
      pricing: {
        ...
        bundle: {
          ...
          setupLabel: "One-time setup, from $100",
          setupOriginal: "$2,650",
          setupNow: "$1,800",
          setupSavings: "Initial savings: $850 USD",
          monthlyLabel: "Monthly maintenance, from $100",
          monthlyOriginal: "$1,000",
          monthlyNow: "$750",
