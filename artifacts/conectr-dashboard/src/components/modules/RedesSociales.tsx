...
const calendarWeek = [
  ...
  { key: "thu", type: "post", icon: "📸", color: "bg-amber-500/20 border-amber-500/40 text-amber-300" },
  ...
  { key: "sun", type: "post", icon: "📸", color: "bg-amber-500/20 border-amber-500/40 text-amber-300" },
];

const postData = [
  { id: 1, platform: "instagram", image: "🌮", tag: "🎬 Reel", tagColor: "text-pink-400", likes: 847, comments: 63, shares: 124, reach: 4200, daysAgo: 2 },
  { id: 2, platform: "instagram", image: "🥑", tag: "📸 Foto", tagColor: "text-amber-400", likes: 621, comments: 42, shares: 88, reach: 3100, daysAgo: 4 },
    ...
    <div className="space-y-8">
      <div className="text-center">
        ...
        <p className="text-muted-foreground max-w-2xl mx-auto">
          {T.description} <span className="text-amber-400 font-medium">{T.descEngagement}</span>{T.descMid}{" "}
          <span className="text-amber-400 font-medium">{T.descFollowers}</span> {T.descAnd}{" "}
          <span className="text-amber-400 font-medium">{T.descClients}</span>{T.descEnd}
        </p>
        <ImpactPills />
      </div>
            ...
            <div className="maya-card rounded-2xl p-5 border border-amber-800/20">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center gap-1.5 px-3 py-1.5 bg-amber-500/10 border border-amber-700/30 rounded-full">
                  ...
                  <span className="text-xs text-amber-300">{CL.live}</span>
                </div>
              </div>
              ...
              <div className="flex flex-wrap gap-3 mt-4 pt-4 border-t border-border/20">
                {[
                  ...
                  { icon: "📸", label: CL.photo, color: "text-amber-400" },
              ...
              {T.calendarStrats.map((card, i) => (
                <div key={card.title} className="maya-card rounded-xl p-4 border border-amber-800/20">
                  <div className="flex items-center gap-2 mb-3">
                    {(() => { const Icon = stratCardIcons[i]; return <Icon size={15} className="text-amber-400" />; })()}
