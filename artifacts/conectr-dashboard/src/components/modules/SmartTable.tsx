...
export default function SmartTable() {
  ...
  const portalButtons = [
    ...
    { id: "reserve", label: T.portalButtons.reserve, icon: Calendar, color: "from-amber-700 to-amber-500", desc: T.reserveDesc, url: "https://tablereserve.conect-r.com/book/roosters-on-the-river" },
  ];
